...
export default function InformationTechnologyPage() {
  return (
    <>
      ...
      <main className="min-h-screen bg-white selection:bg-[#0056b3] selection:text-white">
        {/* Hero Page Banner */}
        <PageBanner
          breadcrumbs={[
            { label: "Home", href: "/" },
          ...
          metrics={[
            ...
            { value: "100%", label: "Data Privacy Compliance", unit: "DPDP" },
        ...
        <section id="security-framework" className="py-12 sm:py-16 bg-white border-b border-stone-200">
          <Container size="default">
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-7 space-y-6">
                ...
                <div className="w-12 h-0.5 bg-[#0056b3]" />
              ...
              <div className="lg:col-span-5 space-y-6 border-t-2 border-[#0b1524] pt-6">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    "Strict alignment with global data protection and privacy standards",
                  ].map((item, i) => (
                    <li key={i} className="flex items-start gap-3 text-sm text-stone-700">
                      <CheckCircle2 className="size-4.5 text-[#0056b3] shrink-0 mt-0.5" />
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
        ...
        <section className="py-12 sm:py-16 bg-[#fbfbfa] border-b border-stone-200">
          <Container size="default">
            <div className="text-center max-w-3xl mx-auto mb-14">
              ...
              <div className="w-12 h-0.5 bg-[#0056b3] mx-auto mt-4 mb-4" />
            ...
            <div className="grid gap-x-8 gap-y-10 md:grid-cols-2 lg:grid-cols-4 lg:gap-x-12">
              {[
                ...
                return (
                  <div key={idx} className="flex flex-col border-t border-[#0b1524]/20 pt-5">
                    <Icon className="size-5 text-[#0056b3]" aria-hidden="true" />
                    <h3 className="mt-3 mb-4 text-lg font-bold text-[#0b1524]">{card.title}</h3>
                    <ul className="space-y-2.5 border-t border-[#e4e2da] pt-4">
                      {card.points.map((pt, pIdx) => (
                        <li key={pIdx} className="flex items-start gap-2 text-xs sm:text-[13px] text-stone-600 leading-snug">
                          <span className="w-1.5 h-1.5 rounded-full bg-[#0056b3] shrink-0 mt-1.5" />
                          <span>{pt}</span>
                        </li>
                      ))}
                    </ul>
        ...
        <section className="py-12 sm:py-16 bg-white border-b border-stone-200">
          <Container size="default">
            <div className="max-w-3xl mb-12">
              ...
              <div className="w-12 h-0.5 bg-[#0056b3] mt-4 mb-4" />
              <p className="text-stone-600 text-base sm:text-lg">
            ...
            <div className="grid gap-x-8 gap-y-10 md:grid-cols-3 lg:gap-x-14">
              {[
                {
                  step: "01",
                ...
                <div key={i} className="space-y-3 border-t-2 border-[#0b1524] pt-6">
                  <div className="text-xs font-extrabold tracking-widest text-[#0056b3] uppercase">
                    Model {item.step}
                  </div>
