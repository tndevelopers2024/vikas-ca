  ...
  return (
    <div className="min-h-screen bg-white text-[#0b1524]">
      ...
      <main>
        ...
        {/* STEPS TIMELINE */}
        <section id="steps" className="scroll-mt-20 border-t border-stone-200 bg-[#fbfbfa] py-12 lg:py-16">
          <Container size="default">
            <SectionHeading
              eyebrow="The Process"
              title="From First Conversation to Daily Delivery"
              description="Four steps, each with a clear owner. You define and approve; we recruit, set up, run, and report."
              align="split"
            />
                ...
                {steps.map((step, index) => {
                  ...
                  return (
                    <div key={step.id} id={step.id} className="relative scroll-mt-24 lg:pl-20">
                      ...
                      <div className="grid gap-8 border-t border-[#0b1524]/15 pt-8 lg:grid-cols-12 lg:gap-12">
